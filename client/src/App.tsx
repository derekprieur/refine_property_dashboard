...
function App() {
  const authProvider: AuthProvider = {
    login: async ({ credential }: CredentialResponse) => {
      ...
      if (profileObj) {
        const response = await fetch('https://refine-property-dashboard.onrender.com/api/v1/users', {
          method: 'POST',
          headers: {
  ...
  return (
    <ColorModeContextProvider>
      ...
      <RefineSnackbarProvider>
        <Refine
          dataProvider={dataProvider("https://refine-property-dashboard.onrender.com/api/v1")}
