                ...
                <form style={{ marginTop: '20px', width: '100%', display: 'flex', flexDirection: 'column', gap: '20px' }} onSubmit={handleSubmit(onFinishHandler)}>
                    ...
                    <Stack direction='row' gap={4}>
                        <FormControl sx={{ flex: 1 }}>
                            ...
                            <Select displayEmpty required color='info' variant='outlined' inputProps={{ 'aria-label': 'Without label' }} defaultValue='apartment' {...register('propertyType', { required: true })}>
                    ...
                    <Stack direction='column' gap={1} justifyContent='center' mb={2}>
                        <Stack direction='row' gap={2}>
                            <Typography fontSize={16} fontWeight={500} color='#11142D' my='10px'>Property Photo</Typography>
